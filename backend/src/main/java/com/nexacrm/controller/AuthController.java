...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> login(
        ...
        // Tenant is resolved by AuthService from the user record in the database.
        // Never accept tenant ID from an untrusted client header — doing so allows
        // an attacker to authenticate a credential against an arbitrary tenant.
