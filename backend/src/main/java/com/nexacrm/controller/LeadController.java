...
public class LeadController {
    ...
    private static final int MAX_NOTES_PAYLOAD_CHARS = 2000;
    ...
    private String buildFacebookLeadNotes(Map<String, Object> payload, String formName, String campaign, String leadgenId) {
        ...
        String rawJson = toPrettyJson(payload);
        if (rawJson.length() > MAX_NOTES_PAYLOAD_CHARS) {
            rawJson = rawJson.substring(0, MAX_NOTES_PAYLOAD_CHARS) + "\n...[truncated]";
        }
        notes.append("\n\nRaw Payload:\n").append(rawJson);
