...
>
> In local development, the backend seeds these demo users automatically. In production, keep `APP_ENV=production` and enable `SEED_DEMO_USERS=true` only if you intentionally want the sample accounts.
